...
export function HeaderControls({ isInline = false }: HeaderControlsProps) {
    ...
    const profileContent = (
        <div className="flex items-center gap-3 pr-4 pl-2 cursor-pointer group/profile">
            <div className="flex flex-col text-right">
                ...
                <span className="text-[10px] font-bold text-muted-foreground/40 transition-all duration-300 group-hover/profile:text-muted-foreground leading-tight truncate max-w-[180px]">
    ...
    if (isInline) {
        return (
            <motion.div 
                className="group relative flex items-center gap-3 p-1.5 rounded-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 backdrop-blur-md transition-all duration-500 hover:bg-black/10 dark:hover:bg-white/10 hover:border-primary/30 hover:shadow-[0_8px_32px_rgba(123,92,250,0.15)]"
            >
                ...
                <div className="h-6 w-[1px] bg-gradient-to-b from-transparent via-black/10 dark:via-white/10 to-transparent mx-1 relative z-10" />
    ...
    return (
        ...
        >
            ...
            <div className="relative flex items-center gap-3 p-1.5 rounded-full backdrop-blur-2xl bg-white/40 dark:bg-black/40 border border-black/5 dark:border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.06)] dark:shadow-[0_0_20px_rgba(0,0,0,0.2)] transition-all duration-500 group-hover:border-black/10 dark:group-hover:border-white/40">
                ...
                {/* Refined Vertical Separator */}
                <div className="h-6 w-[1px] bg-gradient-to-b from-transparent via-black/10 dark:via-white/10 to-transparent mx-1" />
